...
const GET_SPECIFIC_ADOPTER = "SELECT * FROM \"Adopters\" WHERE \"Adopter_id\" = $1";
...
const create_adopter = (Name, Phone) => {
    return db.none(ADD_ADOPTER, [Name, Phone]);
}
...
const get_specific_adopter = (Adopter_id) => {
    return db.any(GET_SPECIFIC_ADOPTER, [Adopter_id]);
}
